const english = {
  ...
  "map.titleDistrict": "{district} operational map",
  "map.titleProvince": "Gyeongsangbuk-do operational map",
  "map.view": "Map view",
  "map.view.auto": "Auto",
  "map.view.flat": "2D",
  "map.view.tilted": "3D",
  ...
  "qr.mobile": "Open the resident app",
  "drill.banner": "Training exercise — not a real incident",
  ...
  "assistant.poweredBy": "Answers generated by Upstage Solar",
...
const korean: Record<TranslationKey, string> = {
  ...
  "map.titleDistrict": "{district} 운영 지도",
  "map.titleProvince": "경상북도 운영 지도",
  "map.view": "지도 보기",
  "map.view.auto": "자동",
  "map.view.flat": "2D",
  "map.view.tilted": "3D",
  ...
  "map.zoomOut": "축소",
  "qr.mobile": "주민 앱 열기",
  "drill.banner": "훈련 상황입니다 — 실제 재난이 아닙니다",
  ...
  "assistant.poweredBy": "Upstage Solar 모델이 답변합니다",
